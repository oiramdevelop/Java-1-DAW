...
public class Mazmorra {
	 ...
	 *********************************/
	/**
	 * La función comprobará que todas las trampas estén activas y que no haya más
	 * de 3 trampas en el nivel pasado como parámetro. Para comprobar las trampas se
	 * deberá utilizar un bucle for que no utilice índice para recorrerlo.
	 * 
	 * @param nivel
	 * @return
	 */
	...
	/**
	 * Esta función dejará claro cual es el final boss de la mazmorra. Deberá de ser
	 * el koala negro o dragon con más ataque y, seamos serios, no puede ser debil a
	 * las cosquillas.
	 * 
	 * Devolverá el monstruo encontrado, si no hay ninguno de esas características,
	 * creará un monstruo horripilante en el nivel 3 que cumpla los requisitos, lo
	 * meterá al final de la mazmorra (última posición de la listaMonstruos) y lo
	 * devolverá.
	 * 
	 * @return
	 */
	...
	public boolean comprobarMazmorra() {
		...
		for (Monstruo mon : this.listaMon) {
			 ...
			 * switch (mon.getTipo()) {
			 * 
			 * case Monstruo.DRAGONES: hayMonstruos[Monstruo.DRAGONES] = true; break; ... }
			 */
